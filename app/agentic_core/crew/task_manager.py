...
工作年限: 5年
工作职位: xx行业 高级xxx开发工程师
求职目标: 寻找高级xxxxx岗位，尤其是涉及xx，xxx等行业及技术栈...，与个人项目经验比较相符
项目经验:  
- 项目1: (项目内容概括总结)
- 项目2: ...
- ...
...
- outline: 知识大纲内容，为一个数组。其中每个节点包含：一级知识点->name, 以及所有二级知识点->content。且 content 中包含 markdown 格式中的序号、 bullet 以及换行。
""",
        expected_output="""
{
    "domain": "操作系统",
...
""",
        expected_output="""{
questions: [
    {"content": "问题1", "difficulty": "easy"},
    {"content": "问题2", "difficulty": "hard"},
    ...
]}
""",
